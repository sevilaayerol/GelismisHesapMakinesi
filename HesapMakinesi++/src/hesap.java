...
public class hesap {
	 ...
	 static void plus() {
	    ...
	    static void mod() {
	        ...
	        System.out.print("Sayý giriniz :");
	        int a = scan.nextInt();
	        System.out.println("Hangi sayi ile mod alacaksýnýz? : ");
	        int b = scan.nextInt();
	        int result = 0;
	        result = a % b;
	    ...
	    static  void alanCevre() {
	    	Scanner scan = new Scanner(System.in);
	        System.out.print("Dikdörtgenin 1. kenarýný giriniz :");
	        int k = scan.nextInt();
	      
	        System.out.print("Dikdörtgenin 2. kenarýný giriniz :");
	        int m = scan.nextInt();
	        
	        if(k==0 || m==0) {
	        	System.out.println("Bu bir dikdörtgen deðildir!");
	        }
	        else {
	        	double cevre = (k + m) * 2;
	        	double alan = k*m;
